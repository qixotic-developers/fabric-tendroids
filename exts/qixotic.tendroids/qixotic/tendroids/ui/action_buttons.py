...
class ActionButtons:
    ...
    def create_ui(self, parent_stack: ui.VStack):
        ...
        with ui.VStack(spacing=5):
            ...
            stress_test_button = ui.Button(
                ...
                tooltip="Automated profiling: 15/20/25/30 Tendroids, 30s each with FPS logging"
            )
    ...
    def _on_stress_test_clicked(self):
        ...
        try:
            from ..test_stress_phase2 import run_default_stress_test
            
            self.status_display.update_status("Starting stress test...")
            carb.log_info("[ActionButtons] Starting Phase 2 stress test with profiling")
            ...
            self.status_display.update_status(
                "Stress test running... (watch console for [PROFILE] logs)"
            )
