...
----
File → Open → C:\Dev\Omniverse\fabric-tendroids\exts\qixotic.tendroids\qixotic\tendroids\cpp
----
...
└── cmake-build-release/        # Build artifacts (gitignored)
    └── Release/
...
|Speed improvement
|*5-10× faster* than pure Python mesh updates
